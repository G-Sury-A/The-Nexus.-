...
function calculateAffinity(a: RawArticle, b: RawArticle): { score: number, commonKeys: string[] } {
  ...
  // ⚡ Bolt Optimization: Use a Set for commonKeys instead of Array.includes()
  // Impact: Reduces O(N^2) deduplication to O(N) constant-time lookups during cross-affinity calculations
