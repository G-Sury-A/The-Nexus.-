...
function tokenize(text: string): string[] {
  ...
  // ⚡ Bolt Optimization: Replace intermediate .filter() with a single-pass loop
  // that pushes directly into the result array to minimize Garbage Collection (GC) overhead.
  const result: string[] = [];
